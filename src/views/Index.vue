<template>
    ...
    <div class="wrapper">
        ...
        <!-- search部分 -->
        <div class="search">
            <div class="search-fixed-top" ref="fixedTop">
    ...
    export default {
        ...
        mounted() {
            document.onscroll = () => {
                ...
                //注意：在html中要添加 ref="fixedTop"
                let search = this.$refs.fixedTop;

                //滚动条超过视口宽度的12%时（因为最上面的定位块高度是：视口宽度*12%），搜索块变固定
        ...
        destroyed() {
            //去掉首页中给document添加的滚动条事件
            document.onscroll = null;
        },
        methods: {
            businessList(orderTypeId) {
                this.$router.push({
                    path: "/businessList",
